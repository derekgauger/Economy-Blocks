...
public class GiveEffects implements CarePackageEvent {
    ...
    public void runEvent(Player player, BankHandler bankHandler) {
        ...
        player.addPotionEffect(new PotionEffect(PotionEffectType.FIRE_RESISTANCE, 20 * 60 * 10, 1));
        player.addPotionEffect(new PotionEffect(PotionEffectType.ABSORPTION, 20 * 60 * 10, 1));
        player.addPotionEffect(new PotionEffect(PotionEffectType.REGENERATION, 20 * 60 * 10, 1));
        ...
        player.addPotionEffect(new PotionEffect(PotionEffectType.FAST_DIGGING, 20 * 60 * 10, 1));
